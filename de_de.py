...
asciiToKeycode = [
	...
	(0x1d, Keycode.LEFT_SHIFT),     # Y
	(0x1c, Keycode.LEFT_SHIFT),     # Z
	(0x25, Keycode.RIGHT_ALT),      # [
	(0x2d, Keycode.RIGHT_ALT),      # bslash \
	(0x26, Keycode.RIGHT_ALT),      # ]
	(0x35),                         # ^
	(0x38, Keycode.LEFT_SHIFT),     # _
    ...
    (0x00), # Ô
    (0x00), # Õ
    (0x33, Keycode.LEFT_SHIFT),     # Ö
    (0x00), # ×
    (0x00), # Ø
    (0x00), # Ù
    (0x00), # Ú
    (0x00), # Û
    (0x2f, Keycode.LEFT_SHIFT),     # Ü
    (0x00), # Ý
    (0x00), # Þ
    (0x2d),                         # ß
    (0x00), # à
